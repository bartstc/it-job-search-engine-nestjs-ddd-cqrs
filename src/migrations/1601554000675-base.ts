...
export class base1601554000675 implements MigrationInterface {
    name = 'base1601554000675'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "offers" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "offer_id" character varying NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "technology" character varying NOT NULL, "level" character varying NOT NULL, "employment_type" character varying NOT NULL, "city_name" character varying NOT NULL, "street_name" character varying NOT NULL, "price_min" integer NOT NULL, "price_max" integer NOT NULL, "currency" character varying NOT NULL, "longitude" numeric NOT NULL, "latitude" numeric NOT NULL, "must_have" text array NOT NULL, "nice_to_have" text array NOT NULL, CONSTRAINT "PK_d611e618dbf3754ffb7fc1ffb38" PRIMARY KEY ("offer_id"))`);
