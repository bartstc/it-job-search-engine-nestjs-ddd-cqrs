...
export class FillOffers1597680922025 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`INSERT INTO offers (offer_id, title, description, company_name, technology, level, employment_type, city_name, street_name, price_min, price_max, currency, longitude, latitude, must_have, nice_to_have)
